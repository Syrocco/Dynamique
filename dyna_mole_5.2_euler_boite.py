...
#Calcul de la pression exercée sur les parois lors de ce que je considère comme le régime permanent
aireBoite=6*TailleBoite**2
duree=dt*N/2

momenTotal=0
for i in range(int(N/2),N):
    momenTotal+=Moment[i]
pression=momenTotal/(duree*aireBoite)
...
temperature=eneCinMoyenne/(1.5*kb)
